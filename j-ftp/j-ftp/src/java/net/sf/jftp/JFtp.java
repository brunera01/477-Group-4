...
import net.sf.jftp.Presentation.gui.base.LogFlusher;
import net.sf.jftp.Presentation.gui.base.RemoteDir;
import net.sf.jftp.Presentation.gui.base.StatusPanel;
import net.sf.jftp.Presentation.gui.base.dir.Dir;
import net.sf.jftp.Presentation.gui.base.dir.DirEntry;
import net.sf.jftp.Presentation.gui.framework.FileTransferable;
import net.sf.jftp.Presentation.gui.framework.GUIDefaults;
import net.sf.jftp.Presentation.gui.framework.HDesktopBackground;
...
import net.sf.jftp.Presentation.gui.tasks.HostInfo;
...
import net.sf.jftp.DataSource.tools.RSSFeeder;
                                            ...
                                            InternalFrameListener
{
    ...
    protected void displayGUI() {
		...
		JOptionPane.showMessageDialog(mainFrame, "Begin by connecting to a server using the connect options "
				+ "under file. Then tranfer files to and from the server by selecting a file on either side "
				+ "and clicking the tranfer (big arrow) button");
	}
